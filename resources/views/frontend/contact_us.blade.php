...
<section
class="max-w-7xl mx-auto relative z-10 overflow-hidden bg-white py-20 lg:py-[220px] px-10"
>
  ...
  <div class="flex flex-wrap -mx-4 lg:justify-between">
    <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
      <div class="mb-12 max-w-[570px] lg:mb-0">
        ...
        <p
          class="text-base leading-relaxed text-body-color  mb-9"
        >
         {!!$info->description!!}
        </p>
        <div class="mb-8 flex w-full max-w-[370px]">
          <div
            class="bg-primary text-white mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded sm:h-[70px] sm:max-w-[70px]"
          >
            <svg
              width="32"
              height="32"
    ...
    <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
      <div
        class="relative p-8 bg-white rounded-lg shadow-lg-2 sm:p-12"
      >
